...
const file_d3_proto_rawDesc = "" +
	"\n" +
	"\bd3.proto\x12\x04p111\"\x14\n" +
	"\x02M1\x12\x0e\n" +
	"\x02m1\x18\x01 \x01(\tR\x02m1\"\x14\n" +
	"\x02M2\x12\x0e\n" +
	"\x02m2\x18\x01 \x01(\tR\x02m22\"\n" +
	"\x02S1\x12\x1c\n" +
	"\x04fun1\x12\b.p111.M1\x1a\b.p111.M2\"\x00B\bZ\x06.;mainb\x06proto3"

var (
	file_d3_proto_rawDescOnce sync.Once
	file_d3_proto_rawDescData []byte
)

func file_d3_proto_rawDescGZIP() []byte {
	file_d3_proto_rawDescOnce.Do(func() {
		file_d3_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_d3_proto_rawDesc), len(file_d3_proto_rawDesc)))
	})
	return file_d3_proto_rawDescData
}

var file_d3_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
func file_d3_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_d3_proto_rawDesc), len(file_d3_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
